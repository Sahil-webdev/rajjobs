...
const adminStudyMaterials = require('./routes/admin/study-materials');
...
app.use('/api/admin/moderation', verifyAccessToken, requireAdmin, adminModeration);
app.use('/api/admin/study-materials', verifyAccessToken, requireAdmin, adminStudyMaterials);
